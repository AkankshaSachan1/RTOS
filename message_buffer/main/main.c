...
void serial_task1(void *data)
{
   ...
   // while(1){
     ...
     xMessageBufferSend(msg,buffer,sizeof(buffer),pdMS_TO_TICKS(10000));
     printf("data sent\n");
   // }
     vTaskDelete(NULL);      
}
...
void serial_task2(void *data)
{
    ...
    //  {
        ...
        st = xMessageBufferReceive(msg,rcv_buff,sizeof(rcv_buff),pdMS_TO_TICKS(10000));
...
void app_main()
{
    ...
    res1 = xTaskCreatePinnedToCore(serial_task1,"Task_1",4096,NULL,8,&task1,TASKCORE);
    if(res1!=pdPASS)
    {
